status_codes = {
    900: 'Success! This API request is deprecated and could be removed in the '
         'future.',
    1000: 'Success!',
    ...
    1110: 'A new integrated application has been added to Fishbowl. Please '
          'contact the Fishbowl administrator to approve this integrated '
          'application.',
    1111: 'This integrated application registration key does not match.',
    1112: 'This integrated application has not been approved by the Fishbowl '
          'administrator.',
    ...
    2506: 'The part tracking _________ is in use or was used and cannot be '
          'deleted.',
    ...
    2515: 'The tracking _________ was not found in location _________ or is'
    ...
    4004: 'PO does not have a PO number. Please turn on the auto-assign PO '
          'number option in the purchase order module options.',
    4005: 'Duplicate order number _________.',
    4006: 'Cannot create PO with configurable parts: _________.',
    4007: 'The following parts were not added to the purchase order. They '
          'have no default vendor:',
    ...
    4105: 'SO does not have a SO number. Please turn on the auto-assign SO '
          'numbers option in the sales order module options.',
    ...
    4304: 'TO does not have a TO number. Please turn on the auto-assign TO '
          'number option in the Transfer Order module options.',
    ...
    5108: 'Incorrect slot for this item. Item must be placed with others for '
          'this order.',
