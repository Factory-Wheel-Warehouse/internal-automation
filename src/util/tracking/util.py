...
from src.util.constants.tracking import ATTACHMENT_CONTENT_TYPE_KEY
from src.util.constants.tracking import ATTACHMENT_ID_KEY
from src.util.constants.tracking import CARRIER_KEY
...
from src.util.constants.tracking import PDF_CONTENT_TYPE
from src.util.constants.tracking import TRACKING_NUMBER_KEY
from src.util.constants.tracking import TRACKING_URL


def po_num_email_search(po_num: str, outlook: OutlookFacade) -> list:
    """
...
def get_pdf_attachments(email_id: str,
                        outlook: OutlookFacade) -> list[bytes]:
    """
...
def get_tracking_from_outlook(po_num: str, outlook: OutlookFacade):
    """
